  ...
  return (
    <div>
      ...
      <div className='flex justify-center items-center w-full h-full'>
        <span className='md:mr-[425px] md:whitespace-pre-line md:w-[420px] md:h-[300px] md:ml-4 md:mt-[1rem] md:text-[42px] font-semibold lg:text-[58px] text-[38px] w-full h-full leading-[96px] lg:-mt-1 mt-34'>Open Source, Free, Simple and easy to use Song Request Twitch Bot.</span>
      </div>
      <div className='flex justify-center items-center flex-wrap w-full'>
        <img src={gif} alt='NODDERS' className='hidden md:block  md:w-[375px] md:h-[265px] md:ml-[25rem] md:-mt-[22rem] w-[186px] h-[178px] lg:ml-[40rem] lg:-mt-60 lg:w-[275px] lg:h-[225px] -mt-[65rem]'/>
      </div>
